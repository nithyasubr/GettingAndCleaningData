...
- 'README.txt' : Provides explanation and details on the submitted files

- 'Tidy_Data.txt' : The combined dataset that has only mean and std variables
...
- 'combined_data_step1.txt' : The combined dataset that has all the 561 variables
			      I have created this in the first step and also enriched
